module TestProject.Page.NotFound.Update exposing (route, init, update, subscriptions, receive)

import TestProject.Page.NotFound.Type exposing (Model, Msg(..), Route)
