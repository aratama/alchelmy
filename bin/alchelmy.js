...
(function($PS) {
  ...
  var exports = $PS["Alchelmy.Template.Root"];
...
(function($PS) {
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(checkProjectDirectory)(function () {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Path.resolve([ "src" ])(application)))(function (dir) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.exists(dir))(function (exists) {
                  ...
                  throw new Error("Failed pattern match at Alchelmy (line 66, column 14 - line 69, column 95): " + [ v.constructor.name ]);
              });
          });
      });
  };
  var generateRouter = function (rootPattern) {
      return function (pagePattern) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(checkProjectDirectory)(function () {
              return Control_Bind.bind(Effect_Aff.bindAff)(getApplicationName)(function (application) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(glob(rootPattern))(function (rootElmFiles) {
                      return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                          if (rootElmFiles.length === 0) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Generating " + (application + "/Root.elm")))(function () {
                                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Path.resolve([ ".", "src", application ])("Root.elm")))(function (path) {
                                      return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.exists(path))(function (rootExists) {
                                          if (rootExists) {
                                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Exception["throw"]("Root.elm already exists"));
                                          };
                                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Buffer_Class.fromString(Node_Buffer.mutableBufferEffect)(Alchelmy_Template_Root.renderRoot(application))(Node_Encoding.UTF8.value)))(function (rootBuffer) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Node_FS_Aff.writeFile(path)(rootBuffer))(function () {
                                                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(path);
                                              });
                                          });
                                      });
                                  });
                          ...
                          if (rootElmFiles.length === 1) {
                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(rootElmFiles[0]);
                          };
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Exception["throw"]("Two or more alchelmy root modules found."));
                      })())(function (rootPath) {
                                              ...
                                              return Control_Bind.bind(Effect_Aff.bindAff)(Data_Traversable["for"](Effect_Aff.applicativeAff)(Data_Traversable.traversableArray)(elmFiles)(pathToModuleName(Effect_Aff.monadEffectAff)))(function (pageModuleNames) {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Foldable.for_(Effect_Aff.applicativeAff)(Data_Foldable.foldableArray)(pageModuleNames)(function (file) {
                                                      ...
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Applicative.when(Effect_Aff.applicativeAff)(Data_Array["null"](pages))(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Exception["throw"]("Page not found."))))(function () {
                                                          return Control_Bind.bind(Effect_Aff.bindAff)(pathToModuleName(Effect_Aff.monadEffectAff)(rootPath))(function (rootModuleName) {
                                                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Buffer_Class.fromString(Node_Buffer.mutableBufferEffect)(Alchelmy_Template_Router.renderRouter(application)(rootModuleName)(pageModuleNames))(Node_Encoding.UTF8.value)))(function (sourceBuffer) {
  ...
  var main = function __do() {
      ...
      if (v.length === 3 && (v[0] === "update" && v[1] === "--page")) {
          return Effect_Aff.launchAff_(generateRouter(defaultRootPattern)(v[2]))();
      };
      if (v.length === 3 && (v[0] === "update" && v[1] === "--root")) {
          return Effect_Aff.launchAff_(generateRouter(v[2])(defaultPagePattern))();
      };
      if (v.length === 5 && (v[0] === "update" && (v[1] === "--root" && v[3] === "--page"))) {
          return Effect_Aff.launchAff_(generateRouter(v[2])(v[4]))();
      };
      if (v.length === 0) {
